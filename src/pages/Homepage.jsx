          ...
          <div className=" mx-auto w-5/6 my-16">
            <div className="flex flex-col w-full justify-center">
              ...
              <p className="flex text-lg justify-center">
                Whether you&apos;re searching for a new place, listing your
                property, or relocating to a new city, Realestway gives you the
                tools and support you need to make smart housing decisions —
                stress-free.
              </p>
            </div>
