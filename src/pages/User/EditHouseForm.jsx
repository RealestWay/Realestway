...
const EditHouseForm = ({ house, isOpen, setIsOpen, setSelectedHouse }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Update the house data with the modified form data
      ...
      alert("There was an error updating the house details.");
    }
  };
          ...
          <div className="bg-white p-8 rounded-lg max-w-4xl w-full relative overflow-hidden">
            ...
            <div className="max-h-[80vh] overflow-y-auto">
              ...
              <form onSubmit={handleSubmit} className="grid gap-6">
                ...
                <label className="text-xs text-gray-500 m-0">Description</label>
                <textarea
                  name="description"
                ...
                <div className="flex gap-4">
                  <div>
                    <label className="text-xs text-gray-500 m-0">Bedroom</label>
                    <input
                      type="number"
                      name="bedrooms"
