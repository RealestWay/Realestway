...
const HouseUploadForm = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-black bg-opacity-50 scrollbar-hide scrollbar-hidden flex items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto scrollbar-hide scrollbar-hidden">
        ...
        <div className="p-6">
          {successMessage && (
            <div className="mb-4 p-4 bg-green-100 flex justify-between text-center text-green-700 rounded">
              {successMessage}
            </div>
          )}
          {error && (
          ...
          <div className="mb-6 w-full flex justify-center items-center flex-col">
            <button
              className="w-3/5 mx-auto p-3 bg-[#00a256] text-white font-semibold rounded-md hover:bg-[#72c19a] transition"
