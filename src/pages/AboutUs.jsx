        ...
        <div className="bg-white px-6 sm:px-12 py-12 max-w-6xl mx-auto text-justify text-gray-800 space-y-16 font-sans">
          <section className="space-y-4 text-lg leading-relaxed">
            <p>
              ...
              should not be a stressful or time-consuming journey. That is why
              we have reimagined the traditional home search to make it smarter,
              faster, and more personalized. Our drive is simple; to eliminate
              the hassle of endless viewings, scattered listings, and
              overwhelming choices. With a combo of technology and expert
              guidance, we connect you with homes that truly match your
              lifestyle, needs, and budget without the guesswork. Whether you
              are buying, renting, or just exploring your options, we are here
              to simplify every step. Just think of us as your trusted partner
              in the home-hunting process, working behind the scenes to make
              sure your next move is smooth, simple, and tailored to you. Allow
              us to take the stress out of your search and help you find a place
          ...
          <section className="bg-white shadow-md shadow-[#100073] rounded-2xl p-6 md:p-8 border border-gray-100">
            ...
            <p className="text-lg leading-relaxed">
              ...
              optimizing every aspect of the experience. Our mission is to
              provide seamless, accessible, and transparent solutions that
              empower buyers, sellers, tenants, and property owners alike.
              Through innovative tools, reliable insights, and a trustworthy
              platform, we simplify transactions and enhance the journey for all
              involved.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-lg leading-relaxed">
              Realestway was born from a real struggle—finding decent housing
              far from home. Tired of slow processes, scams, and vague listings,
              we created a platform to bring trust and speed to relocation and
              housing.
            </p>
          </section>
          ...
          <section className="bg-white shadow-md shadow-[#100073] rounded-2xl p-6 md:p-8 border border-gray-100">
            ...
            <ul className="space-y-2 text-lg list-disc list-inside">
              ...
              <li>
                <strong>Transparency</strong> – No hidden charges, just real
                data.
              </li>
              <li>
                <strong>Community</strong> – We grow with the community we
                serve.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-lg leading-relaxed">
              Realestway is more than a product— it is a movement to
              revolutionize housing for students, young professionals and
              everyone. Whether you are searching, buying, renting, listing, or
              just exploring, welcome to Realestway—
